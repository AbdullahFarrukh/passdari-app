...
function BrandMark() {
  return (
    <svg width="26" height="10" viewBox="0 0 26 10" aria-hidden="true">
      <circle cx="5" cy="5" r="4" fill="#B23A2E" /><circle cx="13" cy="5" r="4" fill="#B23A2E" />
      <circle cx="21" cy="5" r="3.2" fill="none" stroke="#EDE6D6" strokeWidth="1.5" />
    </svg>
  );
}
  ...
  return (
    <header className="bg-charcoal text-paper">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-x-2 gap-y-1 px-3 py-2.5 sm:gap-x-3 sm:px-4">
        <Link href="/" className="flex items-center gap-2.5 font-mono text-sm font-semibold tracking-wider">
          <BrandMark />
          PASSDARI
        </Link>
        ...
        <span className="inline-flex items-center gap-2 rounded-full border border-paper/30 px-2.5 py-1 font-mono text-xs sm:px-3">
          <span className="size-2 rounded-full bg-[#7BC49A]" aria-hidden="true" />
